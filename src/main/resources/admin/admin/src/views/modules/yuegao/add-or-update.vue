<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="主题名称" prop="zhutimingcheng">
          <el-input v-model="ruleForm.zhutimingcheng" 
              placeholder="主题名称" clearable  :readonly="ro.zhutimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="主题名称" prop="zhutimingcheng">
              <el-input v-model="ruleForm.zhutimingcheng" 
                placeholder="主题名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="创作范围" prop="chuangzuofanwei">
          <el-input v-model="ruleForm.chuangzuofanwei" 
              placeholder="创作范围" clearable  :readonly="ro.chuangzuofanwei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="创作范围" prop="chuangzuofanwei">
              <el-input v-model="ruleForm.chuangzuofanwei" 
                placeholder="创作范围" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="稿费" prop="gaofei">
          <el-input v-model="ruleForm.gaofei" 
              placeholder="稿费" clearable  :readonly="ro.gaofei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="稿费" prop="gaofei">
              <el-input v-model="ruleForm.gaofei" 
                placeholder="稿费" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="主题限制" prop="zhutixianzhi">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.zhutixianzhi" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhutixianzhi" label="主题限制" prop="zhutixianzhi">
                    <span v-html="ruleForm.zhutixianzhi"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	zhutimingcheng : false,
	chuangzuofanwei : false,
	zhutixianzhi : false,
	gaofei : false,
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='zhutimingcheng'){
            this.ruleForm.zhutimingcheng = obj[o];
	    this.ro.zhutimingcheng = true;
            continue;
          }
          if(o=='chuangzuofanwei'){
            this.ruleForm.chuangzuofanwei = obj[o];
	    this.ro.chuangzuofanwei = true;
            continue;
          }
          if(o=='zhutixianzhi'){
            this.ruleForm.zhutixianzhi = obj[o];
	    this.ro.zhutixianzhi = true;
            continue;
          }
          if(o=='gaofei'){
            this.ruleForm.gaofei = obj[o];
	    this.ro.gaofei = true;
            continue;
          }
          if(o=='yonghuzhanghao'){
	...
	this.ruleForm.zhutixianzhi = this.ruleForm.zhutixianzhi.replace(reg,'../../../springbootp68f1/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `yuegao/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.yuegaoCrossAddOrUpdateFlag = false;
						 this.parent.search();
