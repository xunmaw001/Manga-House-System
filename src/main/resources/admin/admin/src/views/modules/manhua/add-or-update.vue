    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="漫画名称" prop="manhuamingcheng">
          <el-input v-model="ruleForm.manhuamingcheng" 
              placeholder="漫画名称" clearable  :readonly="ro.manhuamingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="漫画名称" prop="manhuamingcheng">
              <el-input v-model="ruleForm.manhuamingcheng" 
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" label="漫画类型" prop="manhualeixing">
...
export default {
  ...
  methods: {
      ...
      this.$http({
		...
		if(json.yonghuxingming!=''&&json.yonghuxingming){
          ...
          this.$message.error(data.msg);
            ...
            this.manhualeixingOptions = "原创漫画,同人漫画".split(',')
            this.fenleiOptions = "玄幻,科幻,奇幻,仙侠".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
	...
	this.ruleForm.neirong = this.ruleForm.neirong.replace(reg,'../../../springbootp68f1/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
